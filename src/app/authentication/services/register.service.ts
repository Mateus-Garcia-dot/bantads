...
export class RegisterService {
  ...
  async register(cliente: Cliente, endereco: Endereco, autenticacao: Autenticacao) {
    ...
    conta.gerente = (await this.crudGerenteService.getGerenteWithLessClientes()).id
    ...
    const autenticacaoNew = await this.crudAutenticacaoService.createAutenticacao(autenticacao)
  }
}
